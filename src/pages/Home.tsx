    ...
    return (
      <div className='w-full h-screen bg-black'>
        ...
        <div className='flex justify-center mt-14 items-center text-center text-white'>
          <div>
            <div className='text-5xl font-head my-6 md:mt-4 md:text-7xl'>Your Mind's Archive</div>
            <div className='text-sm md:text-lg font-body w-[75%] mx-auto text-gray-300 mt-4 md:mt-6'>
